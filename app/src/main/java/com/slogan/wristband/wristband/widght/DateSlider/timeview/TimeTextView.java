...
public class TimeTextView extends TextView implements TimeView {
     ...
     */
    public TimeTextView(Context context, boolean isCenterView, boolean isCenterLeftView, boolean isCenterRightView, int textSize) {
        super(context);
        setupView(isCenterView, isCenterLeftView, isCenterRightView, textSize);
    }
     ...
     */
    protected void setupView(boolean isCenterView, boolean isCenterLeftView, boolean isCenterRightView, int textSize) {
