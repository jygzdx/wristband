...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = WristbandApplication.getInstance().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = WristbandApplication.getInstance().getSharedPreferences(spName, mode);
    }
