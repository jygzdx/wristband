...
import com.slogan.wristband.wristband.adapter.WheelAdapter;
 ...
 * @author  xiehou001
 */
public class SportWheelView extends View {
	/** Scrolling duration */
	...
	public int ADDITIONAL_ITEM_HEIGHT = 35;

	/** Text size */
	public int TEXT_SIZE;

	public boolean NO_TEXT_BOLD;
	 ...
	 * Constructor
	 */
	public SportWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public SportWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public SportWheelView(Context context) {
		super(context);
		this.context = context;
		initData(context);
	}
	...
	private void initData(Context context) {
		...
		VALUE_TEXT_COLOR=context.getResources().getColor(R.color.main_color);
		ITEMS_TEXT_COLOR=context.getResources().getColor(R.color.text_666);
		//ITEM_OFFSET=Commtool.dip2px(context, 4);
	}
...
//		setBackgroundResource(context.getResources().getColor(R.color.transparent));
...
/*	private void drawShadows(Canvas canvas) {
	...
	public interface OnWheelChangedListener {
		 ...
		 */
		void onChanged(SportWheelView wheel, int oldValue, int newValue);
	}
	...
	interface OnWheelScrollListener {
		 ...
		 *            the wheel view whose state has changed.
		 */
		void onScrollingStarted(SportWheelView wheel);
		 ...
		 *            the wheel view whose state has changed.
		 */
		void onScrollingFinished(SportWheelView wheel);
	}
}
