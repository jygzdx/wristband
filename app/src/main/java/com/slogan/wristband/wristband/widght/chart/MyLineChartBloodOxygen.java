 ...
 */
public class MyLineChartBloodOxygen extends LineChart {
    ...
    public MyLineChartBloodOxygen(Context context) {
        super(context);
        initView(context);
    }

    public MyLineChartBloodOxygen(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public MyLineChartBloodOxygen(Context context, AttributeSet attrs, int defStyle) {
...
//                int index = (int)e.getX();
                ...
                if (selectListener != null) {
                    selectListener.onSelected(e.getX(), e.getY());
                }
...
//        d.setDrawHorizontalHighlightIndicator(false);
    ...
    public void setSelectListener(OnSelectListener selectListenner) {
        this.selectListener = selectListenner;
    }
