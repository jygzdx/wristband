...
public class CircularProgressBar extends View {
    ...
    private float backgroundStrokeWidth = 3;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(rectF.centerX(),strokeWidth,strokeWidth/2,foregroundPaint);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        rectF.set(0 + highStroke , 0 + highStroke , min - highStroke , min - highStroke);
    }
    //endregion
