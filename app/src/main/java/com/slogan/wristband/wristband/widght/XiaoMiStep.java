...
//        ra_inner_circle = heightBg * 9 / 20;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.getTextBounds(String.valueOf(currentFootNum),
                0,String.valueOf(currentFootNum).length(),mBound);
        canvas.drawText(String.valueOf(currentFootNum),
                (widthBg / 2 - mBound.width()/2), heightBg / 2 + mBound.height()/2, textPaint);
